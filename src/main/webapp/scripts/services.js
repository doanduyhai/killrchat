...
killrChat.service('UserRoomsService', function(Room){
    ...
    this.deleteRoomWithParticipants = function(room) {
        return new Room({participants:room.participants}).$delete({roomName: room.roomName});
    }
