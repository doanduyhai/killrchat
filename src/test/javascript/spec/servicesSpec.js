...
describe('Services Tests', function () {
    ...
    describe('UserRoomsService', function () {
        var UserRoomsService, Room;
        beforeEach(inject(function (_UserRoomsService_, _Room_) {
        ...
        it('should delete room with participants',function(){
            ...
            //When
            var actual = UserRoomsService.deleteRoomWithParticipants(room);

            //Then
            expect(objCapture).toBeDefined();
            expect(objCapture.roomName).toBe('games');
            expect(actual.participants).toEqual(['jdoe','hsue']);
        });
    });
